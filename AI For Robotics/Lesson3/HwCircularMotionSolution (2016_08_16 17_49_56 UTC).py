...
##
##
length = 20.  # length of road 
bearing_noise  = 0.0
steering_noise = 0.0
distance_noise = 0.0

myrobot = robot(length)  # initialize length parameter
myrobot.set(0.0, 0.0, 0.0)
myrobot.set_noise(bearing_noise, steering_noise, distance_noise)


 ## cache away a number of motions:[ steering angle, robot motion distance]

## pi/6 is a left steering so the robot should change its coordinates in the beginning just in the x direction
