...
def next_move(hunter_position, hunter_heading, target_measurement, max_distance, OTHER):
    ...
    if not OTHER: # first time calling this function, set up my OTHER variables.
        ...
        print 'measurements', measurements[0], "xy_est", xy_estimate, "OTHER",  OTHER[0][0]
        ...
        print  "xy_est", xy_estimate, 'p3', x3,y3 , "p2", x2,y2, 'p1', x1,y1  
        ...
        heading_difference = heading_to_target - hunter_heading
        turning =  heading_difference # turn towards the target
        distance = max_distance*.75 # full speed ahead!
    return turning, distance, OTHER
...
# NON-VISUAL VERSION OF demo_grading
...
# VISUAL VERSION OF demo_grading
...
def naive_next_move(hunter_position, hunter_heading, target_measurement, max_distance, OTHER = None):
