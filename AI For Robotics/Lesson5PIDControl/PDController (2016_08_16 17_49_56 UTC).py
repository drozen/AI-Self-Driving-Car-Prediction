...
# param1 = taup   param2 = taud_d related to the differential  
def run(param1, param2):
    ...
    steering = -tau_p * prev_crosstrack_error
    ...
    for i in range(N):
        ...
        diff_CTE = crosstrack_error - prev_crosstrack_error
        steering = -tau_p * crosstrack_error - tau_d * diff_CTE
        myrobot = myrobot.move(steering, speed)
