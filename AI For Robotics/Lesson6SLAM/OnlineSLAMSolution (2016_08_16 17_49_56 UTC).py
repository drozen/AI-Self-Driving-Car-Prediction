...
#     PseudoCode
#     
#     same as slam but removes irrelavant info
#     
#     1. expand to the new PositionTest
#     2. remove the  extra using the equatoins
#     
    ...
    for k in range(len(data)):
        ...
        # expand the info matrix and vector by one new position
